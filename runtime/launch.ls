...
launch_kernel elf_entry_gpu_va grid_x grid_y grid_z block_x block_y block_z shmem_size params_ptr params_size :
    ...
    \\ --- 5. Emit the QMD submission sequence (6 method groups) ---
    pb_emit_qmd pb_ptr qmd_gpu_va qmd_gpu_va

    \\ --- 6. Compute advance. pb_emit_qmd advances pb_ptr's internal cursor
    ...
    \\ --- 7. Publish GPPut and ring the doorbell ---
...
launch_kernel_sync elf_entry_gpu_va grid block shmem_size params_ptr params_size done_flag_gpu_va :
    launch_kernel elf_entry_gpu_va grid grid grid block block block shmem_size params_ptr params_size
